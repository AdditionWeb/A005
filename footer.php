	...
	<div class="container">
		...
		if ( ! empty( $zerif_socials_facebook ) || ! empty( $zerif_socials_twitter ) || ! empty( $zerif_socials_linkedin ) || ! empty( $zerif_socials_behance ) || ! empty( $zerif_socials_dribbble ) ||
			...
			if ( ! empty( $zerif_socials_facebook ) || ! empty( $zerif_socials_twitter ) || ! empty( $zerif_socials_linkedin ) || ! empty( $zerif_socials_behance ) || ! empty( $zerif_socials_dribbble ) ) {
                ...
                /* youtube */
				if ( ! empty( get_option( 'a005_socials_youtube' )  ) ) {
					echo '<li id="youtube"><a' . ' target="_blank"' . ' href="' . esc_url( get_option( 'a005_socials_youtube' ) ) . '"><span class="sr-only">' . __( 'Youtube link', 'a005' ) . '</span> <i class="fa fa-youtube-play"></i></a></li>';
				}
